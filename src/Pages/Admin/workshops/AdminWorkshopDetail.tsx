...
import AdminWorkshopEdit from "./AdminWorkshopEdit.tsx";
...
const AdminWorkshopDetail: React.FC = () => {
  ...
  const handleDelete = async () => {
    try {
      ...
      console.error("Error occurred while deleting the workshop:", error);
