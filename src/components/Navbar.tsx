...
import {BiBookOpen, BiHome, BiNews} from "react-icons/bi";
      ...
      <nav>
        <div className="nav-logo-container p-3" style={{ backgroundColor: '#071952', marginLeft: '0px', width: '100vw', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div className="navbar-links-container flex">
            <Link to="/home" style={{ color: '#fff' }} className="flex items-center gap-2"><BiHome className='icon'/>Home</Link>
            <Link to="/news" style={{ color: '#fff' }} className="flex items-center gap-2"><BiNews className='icon'/>News</Link>
            <Link to="/course" style={{ color: '#fff' }} className="flex items-center gap-2"><BiBookOpen className='icon'/>Courses</Link>
            <Link to="/about" style={{ color: '#fff' }} className="flex items-center gap-2"><InfoIcon className='icon'/>About</Link>
