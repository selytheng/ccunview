                    ...
                    <div className="py-12 flex justify-center rounded-xl border border-white bg-white shadow-md shadow-black/5 saturate-200">
                        <div className="my-8 grid gap-6 px-4">
                            <ContactDetail
                                ...
                                text="123 Main Street, Los Angeles, CA"
                            />
                            <ContactDetail
                                iconPath="M1.5 4.5a3 3 0 013-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 01-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 006.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 011.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 01-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5z"
                                text="+1 123 456 7890"
                            />
                            <ContactDetail
                                iconPath="M1.5 8.67v8.58a3 3 0 003 3h15a3 3 0 003-3V8.67l-8.928 5.493a3 3 0 01-3.144 0L1.5 8.67z"
                                text="info@lahospital.com"
                            />
                            <ContactDetail
                                iconPath="M1.5 6.375c0-1.036.84-1.875 1.875-1.875h17.25c1.035 0 1.875.84 1.875 1.875v3.026a.75.75 0 01-.375.65 2.249 2.249 0 000 3.898.75.75 0 01.375.65v3.026c0 1 ```tsx
.035-.84 1.875-1.875 1.875H3.375A1.875 1.875 0 011.5 17.625v-3.026a.75.75 0 01.374-.65 2.249 2.249 0 000-3.898.75.75 0 01-.374-.65V6.375zm15-1.125a.75.75 0 01.75.75v.75a.75.75 0 01-1.5 0V6a.75.75 0 01.75-.75zm.75 4.5a.75.75 0 00-1.5 0v.75a.75.75 0 001.5 0v-.75zm-.75 3a.75.75 0 01.75.75v.75a.75.75 0 01-1.5 0v-.75a.75.75 0 01.75-.75zm.75 4.5a.75.75 0 00-1.5 0V18a.75.75 0 001.5 0v-.75zM6 12a.75.75 0 01.75-.75H12a.75.75 0 010 1.5H6.75A.75.75 0 016 12zm.75 2.25a.75.75 0 000 1.5h3a.75.75 0 000-1.5h-3z"
                        ...
                        <div className="py-4">
                            <form action="#">
                                ...
                                <InputField name="Phone Number" type="tel" placeholder="Enter your phone number" />
                                <InputField name="Message" type="textarea" placeholder="Enter your message" />
                                <div className="inline-flex items-center">
                                    <label className="relative flex items-center cursor-pointer p-3 rounded-full -ml-2.5" htmlFor="privacy-checkbox">
                                        <input
                                            type="checkbox"
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor" stroke="currentColor" strokeWidth="1">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"></path>
                                    ...
                                    <label className="text-gray-700 font-light select-none cursor-pointer mt-px" htmlFor="privacy-checkbox">
                                ...
                                <button
                                    className="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg bg-[#071952] text-white shadow-md shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none block w-full mt-6"
                                    type="button"
                                >
                                    Contact Us
                                </button>
...
const ContactDetail: React.FC<{ iconPath: string; text: string }> = ({ iconPath, text }) => (
    <div className="flex items-center gap-4">
        ...
        <p className="block antialiased font-sans text-base leading-relaxed text-inherit font-bold">{text}</p>
    </div>
);

const InputField: React.FC<{ name: string; type?: string; placeholder: string }> = ({ name, type = 'text', placeholder }) => (
    <div className="mb-4">
        <div className="relative w-full min-w-[200px] h-11 !min-w-full">
            <input
                ...
                placeholder=" "
            />
            <label className="flex w-full h-full select-none pointer-events-none absolute left-0 font-normal !overflow-visible truncate peer-placeholder-shown:text-blue-gray-500 leading-tight peer-focus:leading-tight peer-disabled:text-transparent peer-disabled:peer-placeholder-shown:text-blue-gray-500 transition-all -top-1.5 peer-placeholder-shown:text-sm text-[11px] peer-focus:text-[11px]">
                {placeholder}
            </label>
        </div>
    </div>
